...
control MyIngress(inout headers hdr,
    ...
    action operation_add() {
        meta.intrinsic_metadata.ingress_global_timestamp = hdr.p4calc.operand_a;
        send_back(meta.intrinsic_metadata.ingress_global_timestamp);
    }
...
control MyEgress(inout headers hdr,
                 inout metadata meta,
                 inout standard_metadata_t standard_msource := $(wildcard *.p4)
etadata) {
    apply { }
}
